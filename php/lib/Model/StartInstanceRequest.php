 ...
 */
class StartInstanceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets instance_id
     *
     * @param string|null $instance_id Optional user-generated UUID to enforce idempotency
     *
     * @return self
     */
     ...
     * Sets business_key
     *
     * @param string|null $business_key Business tracking keyword
     *
     * @return self
     */
